...
from uapc_aiacad.jobs.transformation_jobs.finding_top_and_flop_art_per_unit_job import FindTopAndFlopTenArticlesPerUnitEtlJob
# COMMAND ----------
...
try:
    finding_top_and_flop_art_per_unit = FindTopAndFlopTenArticlesPerUnitEtlJob(config=config)
    finding_top_and_flop_art_per_unit.run()
