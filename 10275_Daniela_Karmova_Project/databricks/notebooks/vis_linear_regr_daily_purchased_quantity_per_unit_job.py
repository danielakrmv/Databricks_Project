...
from uapc_aiacad.jobs.visualization_jobs.vis_linear_regr_of_daily_purchased_quantity_per_unit_job import VisDailyDistributedQuantityPerUnitPredictJob
# COMMAND ----------
...
try:
    plot_vis_daily_distributed_quantity_per_unit_linear_regr_job = VisDailyDistributedQuantityPerUnitPredictJob(config=config)
    plot_vis_daily_distributed_quantity_per_unit_linear_regr_job.run()
