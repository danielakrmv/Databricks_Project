...
from uapc_aiacad.jobs.transformation_jobs.filtered_bons_correct_and_take_names_of_articles_job import GetFilteredSalesDFEtlJob
# COMMAND ----------
...
try:
    job = GetFilteredSalesDFEtlJob(config=config)
    job.run()
