...
from uapc_aiacad.jobs.visualization_jobs.vis_top_and_flop_art_per_weight_job import VisTopAndFlopArtPerWeightEvlVis
# COMMAND ----------
...
try:
    vis_top_and_flop_art_per_weight = VisTopAndFlopArtPerWeightEvlVis(config=config)
    vis_top_and_flop_art_per_weight.run()
